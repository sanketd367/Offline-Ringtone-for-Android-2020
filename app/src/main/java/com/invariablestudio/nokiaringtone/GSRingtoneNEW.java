...
public class GSRingtoneNEW {
    ...
    public GSRingtoneNEW(int AUDIO_ID, String AUDIO_RAWFILENAME, String AUDIO_SHOWFILENAME, String AUDIO_MYNAME, String AUDIO_FAVOURITE, int AUDIO_RELCOUNT) {
